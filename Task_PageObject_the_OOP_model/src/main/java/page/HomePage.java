...
public class HomePage extends FormFindHotel {
    ...
    public HomePage() {
        super(HOME_PAGE_INPUT_LOCATION_XPATH, HOME_PAGE_BUTTON_CHECK_IN_XPATH, HOME_PAGE_BUTTON_CHECK_OUT_XPATH,
                ...
                HOME_PAGE_TEXT_MONTH_XPATH, HOME_PAGE_TEXT_DAY_XPATH, HOME_PAGE_DROPDOWN_TEXT_AMOUNT_XPATH,
                HOME_PAGE_BUTTON_ADD_MIN_XPATH, HOME_PAGE_BUTTON_DONE_XPATH);
        header = new Header();
 ...
 //       new HomePage();
  ...
  //      new HomePage();
    ...
    public ResultsSearchPage searchForHotel(String location, String monthIn, String dayIn, String yerIn,
